...
st.sidebar.image('https://png.pngtree.com/png-clipart/20210711/original/pngtree-olympic-games-2021-design-in-transparent-background-png-image_6517310.jpg')
...
if user_menu == 'Overall Analysis':
    ...
    fig = px.line(athlete_over_time, x="Year", y="count", title="Athletes over the Years")
